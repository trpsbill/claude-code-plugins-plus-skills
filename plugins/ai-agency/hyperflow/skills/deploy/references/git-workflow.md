...
... workers execute tasks ...
    |
Reviewer: Task approved + quality gates pass
    |
...
... all tasks done ...
    |
Final Reviewer: integration review passes
    |
Orchestrator: Ask: squash into one commit or keep individual?
```
...
3. Reviewer reviews the resolution
