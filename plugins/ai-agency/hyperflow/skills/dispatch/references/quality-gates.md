...
Automated checks that must pass before a worker's output is approved. Runs after code review, before marking a task done.
...
4. Max 3 retry loops per gate. After 3 failures, surface the error to the user
